...
<head>
    ...
    <title>Sign In | Pembayaran Listrik</title>
    <!-- Favicon-->
    <link rel="icon" href="<?=base_url()?> assetsfavicon.ico" type="image/x-icon">
...
<body class="login-page">
    <div class="login-box">
        <div class="logo">
            <a href="javascript:void(0);">PEMBAYARAN<b>LISTRIK</b></a>
            <small></small>
        </div>
        <div class="card">
            <div class="body">
